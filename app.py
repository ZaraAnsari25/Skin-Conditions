...
PREDICTED_LABELS = ['Acne and Rosacea Photos', 'Atopic Dermatitis Photos', 'Eczema Photos', 'Herpes HPV and other STDs Photos', 'Melanoma Skin Cancer Nevi and Moles', 'Psoriasis pictures Lichen Planus and related diseases', 'Seborrheic Keratoses and other Benign Tumors', 'Urticaria Hives', 'Vasculitis Photos', 'Warts and other viral infections']


def get_prediction(image_data):
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/90172813-062b-4e42-bf42-5ce4ef94ca21'
...
st.title("AI in Dermatology")#change according to your project
